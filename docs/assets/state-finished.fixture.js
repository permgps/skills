...
globalThis.MAESTRO_STATE = {
  ...
  "gates": [
    ...
    },
    {
      ...
      "status": "passed",
      "findings": [
        "T04 — вёрстка шапки описана без ширины контейнера; acted on: ширина взята из спеки, 1120px",
        "T07 — таск не называл, куда уходит форма; acted on: адрес добавлен в интерфейсы",
        "T11 — два таска правили один файл; acted on: разведены по волнам"
      ]
    },
    {
      "id": "G4",
